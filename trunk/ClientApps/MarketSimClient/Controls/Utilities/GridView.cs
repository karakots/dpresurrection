...
namespace MarketSimUtilities
{
	...
	public class GridView : System.Windows.Forms.Form
	{
		...
		{
			this.mrktSimGrid1.WriteToCVS(writer);
		}
		...
		public bool Suspend
		{
			set
			{
				this.mrktSimGrid1.Suspend = value;
			}
		}
		...
		private void InitializeComponent()
		{
			...
			this.Name = "GridView";
			this.Closing += new System.ComponentModel.CancelEventHandler(this.GridView_Closing);
		...
		private void GridView_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			mrktSimGrid1.Flush();
