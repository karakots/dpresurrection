...
namespace Common.Utilities
{
	...
	public class DataMatrix : DataTable
	{
		...
		private string headerText; // "Product"
		private string colKeyName; // "product_id";
		private string rowKeyName; //"segment_id";
		private string rowName; // "product_name"
		private string colName; // "segment_name"
		private string valName; // "initial", ...
		...
		public void Flush()	
		{
			...
			foreach (DataRow valRow in rows)
			{
				...
				tmp = valRow[rowKeyName].ToString();
		...
		{	
			string rowID = valRow[rowKeyName].ToString();
			string colID = valRow[colKeyName].ToString();
