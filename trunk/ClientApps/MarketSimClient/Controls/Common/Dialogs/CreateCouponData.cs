...

{
	...
	public class CreateCouponData : System.Windows.Forms.Form

	{
		...
		public CreateCouponData(ModelDb db, MrktSimDBSchema.market_planRow plan)

		{
			...
			planData1.Type = (ModelDb.PlanType) plan.type;

			planData1.NewPlanRow +=new Common.Utilities.PlanData.CreatePlanData(this.planData_NewPlanRow);
...

		{
			...
			this.attributeIBox.Location = new System.Drawing.Point(136, 80);
			...
			this.label4.Text = "Percent Receiving";
			...
			this.persuasionBox.Location = new System.Drawing.Point(136, 144);
			...
			this.awarenessBox.Location = new System.Drawing.Point(136, 112);
			...
			this.Controls.Add(this.attributeIBox);
			...
			this.Name = "CreateCouponData";

			this.Text = "Create Coupon Data";
...

		{
			...
			string couponType = typeBox.SelectedItem.ToString()[0].ToString();



			MrktSimDBSchema.mass_mediaRow media = theDb.CreateMassMedia(productID, channelID, segmentID, couponType);
