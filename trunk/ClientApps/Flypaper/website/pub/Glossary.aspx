...
<head runat="server">
    <title>AdPlanit Glossary of Advertising Terminology</title>
...
<div style="height:29px;">&nbsp;</div>
       ...
       <div ID="ContentDiv" runat="server" visible="true">    
        <table ID="ContentTable" cellpadding="0" cellspacing="0" width="100%">
           <tr>
               ...
               <div id="RHDiv"></div>
                <div ID="RHDiv1"  style="display:none;">Video Guides<br /><br />
                <a href="#">Creating an Advertising Campaign with AdPlanit</a><br /><br />
                <a href="#">How AdPlanit Works Using Virtual Customers</a><br /><br />
                </div>
                <div ID="RHDiv2">What's New:<br /><br />bla bla bla...</div>
               </td>
           </tr>
           <tr>
               <td ID="GlossaryCell" runat="server" style="position:relative; top:0px; width:615px; vertical-align:top; height:460px;" >&nbsp; </td>
           </tr>
           <tr>
      ...
      <ul class="nav">
            <li><a href="#" id="A3" class="nav_advertising active" onclick="ShowMainWaitCursor(); return true;" ></a></li>
