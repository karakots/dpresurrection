<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReceivePlanCheck.aspx.cs" Inherits="ReceivePlanCheck" %>
...
<div style="height:29px;">&nbsp;</div>
       ...
       <%-- End of standard header --%>
        ...
        <asp:Button runat="server" ID="OKButton"  OnClick="GoButton_Click" Text="OK - Add Plan" />
        <asp:Button runat="server" ID="CancelButton" Text="Cancel"  PostBackUrl="~/ReceivePlanEntry.aspx"/><br /><br />
