...
namespace ExcelInterface
{
	public class ExcelReaderWriter
	{
        ...
        //JimJ
        public void CopyCells( int sourceStartRow, int sourceStartCol, int sourceEndRow, int sourceEndCol, int destRow, int destCol ) {
            ws.get_Range( ws.Cells[ sourceStartRow, sourceStartCol ], ws.Cells[ sourceEndRow, sourceEndCol ] ).Copy( ws.Cells[ destRow, destCol ] );
        }

        // JimJ
        public double GetRowHeight( int row ) {
            object o = ((Range)ws.Cells[ row, 1 ]).RowHeight;
            if( o != null ) {
                return (double)o;
            }
            else {
        ...
        // JimJ
        /// <summary>
        /// Makes a copy of the worksheet, after all other worksheets in the file.
        /// </summary>
        public void CopyWorksheetToEnd() {
            ws.Copy( Type.Missing, wb.Sheets.get_Item( wb.Sheets.Count ) );
        }
