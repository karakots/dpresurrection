...
namespace BrandManager.Forms
{
	...
	/// </summary>
	public class EditChoice03 : System.Windows.Forms.UserControl, Wizard
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Would you like to create another scenario or modify an existing one?";
			// 
			// EditChoice03
			// 
