...
namespace BrandManager.Forms
{
	...
	/// </summary>
	public class EditChoice01 : System.Windows.Forms.UserControl, Wizard
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Would you like to modify the data by adding parameters to the market plans? ";
			// 
			// label2
			// 
			...
			this.label2.Text = "This can be used to increase things like price and persuasion for a group of prod" +
				"ucts by a fixed percentage";
			// 
			// EditChoice01
			// 
		...
		public bool Next()
		{
			// TODO:  Add EditChoice01.Next implementation
			return true;
		}
