...
namespace BrandManager
{
	...
	public class BrandMan : System.Windows.Forms.Form
	{
		...
		public BrandMan()
		{
			...
			linkList.Add(setUpLink);
			linkList.Add(createScenarioLink);
			linkList.Add(metricLink);
			linkList.Add(checkScenarioLink);
			linkList.Add(checkScenarioLink2);
		...
		private void InitializeComponent()
		{
			...
			this.panel2.Location = new System.Drawing.Point(184, 326);
