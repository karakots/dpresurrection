...
{
    /// <summary>
    /// This class handles conversion and writing of imported data into the Distribution worksheet of a MarketSim-format file.
    /// </summary>
    class DistributionSheetWriter : IMarketPlanSheetWriter
    {
        ...
        public void WriteData( WorksheetSettings worksheetSettings, ProjectSettings currentProject, ExcelWriter2 writer, int channelIndex ) {
            ...
            this.awareness = currentProject.DistributionAwareness;
            this.persuasion = currentProject.DistributionAwareness;
            ...
            if( numGroups > 0 ) {
                string msgg = String.Format( "\r\n    DistributionSheetWriter -- Groups Detected: {0}    \r\n", numGroups );
            ...
            for( int v = 0; v < variantCount; v++ ) {
                ...
                for( int i = 0; i < data.Count; i++ ) {
                    ...
                    item = Utils.GetGroupedItem( item, channelIndex, i, worksheetSettings, variantGroups[ v ], Utils.ComponentType.Distribution );
                    ...
                    if( writeOnDeckItem ) {
                        ...
                        tableValues[ outrow, 2 ] = onDeckItem.Value1;                                       //% Dist
                        tableValues[ outrow, 3 ] = onDeckItem.Value1;                                       //% Init
                        ...
                        if( writeCSV ) {
                            string csvVal = String.Format( "{0}, {1}, {2}, {3}, {4}, {5}, {6}, {7}", variantName, channel, onDeckItem.Value1, onDeckItem.Value1, awareness, persuasion,
