...
namespace HouseholdManager
{
    public partial class PopulationGenerator : Form
    {
        ...
        public PopulationGenerator(DirectoryInfo save_folder, Dictionary<int, HouseholdManager.geo_info> geo_info)
        {
            rand = new Random();
        ...
        private void auto_browse_Click(object sender, EventArgs e)
        {
        ...
        private void GenerateTimer_Tick(object sender, EventArgs e)
        {
            ...
            build_houses(geo_id, save_folder.FullName);
        ...
        private void build_houses(int geo_id, string save_path)
        {
            Household house;
            ...
            houses.Clear();
            //FileStream file = new FileStream(save_path + "\\" + geo_id, FileMode.OpenOrCreate);
            //formatter.Serialize(file, houses);
            //file.Close();
        }
        ...
        {
            if (!age_dict.ContainsKey(house.Race) || !age_dict[house.Race].ContainsKey("ADULT"))
            {
                return false;
            }
        ...
        private void get_child(Household house, out Person person)
        {
            ...
            {
                person = new Person(random_gender(), person_race, rand.Next(0, 18));
            }
            else
            {
