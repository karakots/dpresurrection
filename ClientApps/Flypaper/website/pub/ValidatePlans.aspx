<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ValidatePlans.aspx.cs" Inherits="ValidatePlans" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Media Plan Entry Error</title>
    <link rel="stylesheet" type="text/css" href="~/styles/ErrorPage.css" />     
</head>
<body>
    <form id="form1" runat="server">
    <input type="hidden" name="UsingPage" id="UsingPage"  runat="server"/>
    <div id="MainDIv">
      ...
      <asp:Label runat="server" ID="PhoneLabel" Text="Where Advertising Starts"></asp:Label>  
       ...
       <%-- End of standard header --%>
        ...
        <asp:Label ID="SubTitle" runat="server" Text="Step 2 – Specify Media Plan(s)"/>
