<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckProgress.aspx.cs" Inherits="CheckProgress" %>
    ...
    <div id="MainDIv" >
      <%-- Start of standard header --%>
       ...
       <asp:Image runat="server" ID="BreadcrumbLabel"  ImageUrl="images/Breadcrumbs3.gif"></asp:Image>  
        ...
        <ul class="nav">
            <li></li>
            <li><a href="HQ.aspx" id="ctl00_NavHome" class="nav_home active" onclick="ShowMainWaitCursor(); return true;" ></a></li>
        </ul>
