<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Timing.aspx.cs" Inherits="Timing" %>
...
<body id="PageBody"  runat="server">
    ...
    <input type="hidden" ID="ExpandedItemIndexes" name="ExpandedItemIndexes" runat="server" />
    <input type="hidden" ID="newPlanName" name="newPlanName" runat="server" />
    <input type="hidden" ID="numRows" name="numRows" runat="server" />
    <input type="hidden" ID="totalExpression" name="totalExpression" runat="server" />
    <input type="hidden" ID="PlanStartYear" name="PlanStartYear" runat="server" />
    <input type="hidden" ID="PlanStartMonth" name="PlanStartMonth" runat="server" />
    <input type="hidden" ID="PlanStartDay" name="PlanStartDay" runat="server" />
    <input type="hidden" ID="LeadDateYear" name="LeadDateYear" runat="server" />
    <input type="hidden" ID="LeadDateMonth" name="LeadDateMonth" runat="server" />
    <input type="hidden" ID="LeadDateDay" name="LeadDateDay" runat="server" />
    <input type="hidden" ID="PlanEndYear" name="PlanEndYear" runat="server" />
    <input type="hidden" ID="PlanEndMonth" name="PlanEndMonth" runat="server" />
    <input type="hidden" ID="PlanEndDay" name="PlanEndDay" runat="server" />
...
<div style="height:29px;">&nbsp;</div>
       ...
       <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
               <td colspan="2" ID="TitleDiv" runat="server" style="width:50%;color:Black;padding-bottom:9px;font-size:10pt;" ><b>Ad Details</b>&nbsp;&nbsp;&nbsp;<span ID="PlanNameSpan" runat="server"></span></td>
               <td style="width:30%;color:Black;padding-bottom:9px;font-size:10pt;padding-left:15px;" ><a id="ChangePlanLink" runat="server" href="#" >Plan:</a>&nbsp;<span ID="PlanNameLabel" runat="server"></span></td>
               <td ID="GrandTotal" colspan="3"  runat="server" style="width:20%;color:Black;padding-bottom:9px;font-size:10pt;padding-left:15px;" >Total:&nbsp;$&nbsp;0</td>
           </tr>
           <tr>
               <td ID="InfoListDiv" runat="server" colspan="6" >Plan Info Area</td>
           </tr>
           <tr>
               <td ID="Td2" runat="server" style="width:35%;color:Black;padding-bottom:9px;font-size:11pt;padding-left:15px;" >&nbsp;</td>
               <td ID="Td3" runat="server"   style="width:30%;padding-bottom:9px;padding-left:35px;"><asp:ImageButton runat="server" ImageUrl="images/OKButton.gif" ID="OKButton" OnClick="OKButton_Click" OnClientClick="return CheckEnteredDates();" />&nbsp;&nbsp;<asp:ImageButton runat="server" ImageUrl="images/CancelButton.gif" ID="ImageButton2" OnClick="CancelButton_Click" /></td>
